class RailRouting {
  ...
  enableRailRoute(apiKey) {
    this.getRailRoute(apiKey).then((railResponse) => {
      ...
      if (
        typeof this.mapService.map.getSource("railRouteSource") === "undefined"
      ) {
      ...
      this.mapService.map.flyTo({ center: [-104.892532, 39.111309], zoom: 8 });
